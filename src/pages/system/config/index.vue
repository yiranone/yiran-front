            ...
            <template v-if="advanced">
              ...
              <a-col :md="8" :sm="24">
                <a-form-item label="创建时间">
                  <a-range-picker style="width: 100%" v-model="queryParam.dateRange" valueFormat="YYYY-MM-DD" format="YYYY-MM-DD" allow-clear/>
                </a-form-item>
              </a-col>
            </template>
...
export default {
  ...
  created () {
    this.getList()
    metadataSource.dictListByType('system_yes_no').then(data => {
