      ...
      <a-col :md="8" :sm="24">
        ...
        >
          <a-select v-decorator="['type']" placeholder="请选择币名称">
            <a-select-option value="">全部</a-select-option>
            <a-select-option value="EXTERNAL_DEPOSIT">客户充值</a-select-option>
            <a-select-option value="INTERNAL_DEPOSIT">内部充值</a-select-option>
            <a-select-option value="GATHER_DEPOSIT">归集充值</a-select-option>
            <a-select-option value="GIVE_OUT_DEPOSIT">发放充值</a-select-option>
          </a-select>
        </a-form-item>
      </a-col>
      <a-col :md="8" :sm="24">
